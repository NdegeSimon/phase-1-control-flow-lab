...
describe('index.js', function () {
  describe('scuberGreetingForFeet()', function () {
    ...
    if('charges 20 dollars for a distance between 400 and 2000 feet', function () {
      expect(scuberGreetingForFeet(1500)).to.equal('That will be twenty bucks.');
    });

    else if('charges 30 dollars for a distance over 2000 feet', function () {
      expect(scuberGreetingForFeet(2001)).to.equal('I will gladly take your thirty bucks.');
    });

    else if('does not allow rides over 2500 feet', function () {
